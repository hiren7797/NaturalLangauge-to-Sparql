    ...
    def run(self):
        ...
        for table_of_from in self.tables_of_from:
            ...
            for i in range(0, len(column_offset)):
                ...
                default1=self.get_column_name_with_alias_table(columns_of_where[i],table_of_from)
                ...
                where_object.add_condition(junction, Condition(column, operation_type, operator, value),default1)
